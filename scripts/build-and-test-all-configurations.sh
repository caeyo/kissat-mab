...
all="--default -m32 -c -g -l -s --dechash --heap-argmax --shadow --no-decision-metrics --coverage --profile --compact --no-options --quiet --metrics --stats --no-proofs -fPIC --shared --kitten --no-metrics --no-stats -flto"
